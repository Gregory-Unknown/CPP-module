...
{
	std::cout << "Default constructor Clap!" << std::endl;
}
ClapTrap::ClapTrap(const std::string &name) : m_name(name), m_hitpoints(10), m_energyPoint(10), m_attackDamage(0)
{
	std::cout << "Init constructor Clap!" << std::endl;
}
...
{
	std::cout << "Assignation operator Clap!" << std::endl;
	if (this != &trap)
	{
		m_name = trap.m_name;
